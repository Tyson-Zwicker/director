...
export default function init() {
  ...
  let star = new Actor('Star', Polygon.makeRegular(40, 1100), new Appearance('#FFA', '#FFF', "Star", 3));
  ...
  let planet3 = new Actor('Planet2', Polygon.makeRegular(16, 30), new Appearance('#090', '#69F', 3));
  ...
  let planet2 = new Actor('Planet3', Polygon.makeRegular(20, 150), new Appearance('rgba(93, 44, 61, 1)', '#FFF', 3));
